...
export class AdminCategoriesController {
  constructor(
    ...
    private readonly uploadImageUC: UploadCategoryImageUseCase,
  ) {}
  ...
  @Post(':id/image')
  @ApiOperation({ summary: 'Upload de imagem da categoria (substitui a anterior)' })
  ...
  async uploadImage(
    ...
    const c = await this.uploadImageUC.execute({
      id,
      buffer: file.buffer,
      mimeType: file.mimetype,
      originalName: file.originalname,
    });
    return { id: c.id.toString(), imageUrl: c.imageUrl };
  }
